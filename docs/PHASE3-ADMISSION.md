...
| S1.2 Profile matrix | Static, Validation, Report, and Post-exploitation must expose only their exact content slot and execution mode while retaining common hardening and cleanup | PASS (`35553910680`) |
